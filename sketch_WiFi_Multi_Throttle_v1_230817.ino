/* "WiCAB" WiFi Single/Multi Throttle for JMRI. Version V3.8.17.
...
String vrs = "Version 3.8.17.0";  // y.m.d.t#
WiFiClient client;
/////////////////////////////////////////////////////////////////////////////////
// compile options:
//#define LOG
...
void sendadr() {
  ...
  if (sfnum != 99) {
    ...
    fading = false;
    #ifdef LOG
    if (DEBUG == true) Serial.println("Sound for this loco is not faded");
    #endif
  }
  bldfctidx();
  #ifdef LOG
